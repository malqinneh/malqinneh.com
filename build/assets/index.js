...
ready(function () {
	...
	$main.find('a').on('mouseover', function () {
		return $main.addClass('hovered');
	}).on('mouseout', function () {
		return $main.removeClass('hovered');
	});
...
},{"../../config":2,"./lib/dot":38,"cash-dom":3,"domready":4,"engine.io-client":5,"randf":36}],2:[function(require,module,exports){
module.exports={
	"port": 8081,
	"dots": {
		"colors": [
...
},{"../../../config":2,"cash-dom":3,"randf":36,"velocity-animate":37}]},{},[1]);
