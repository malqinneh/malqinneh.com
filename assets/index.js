...
},{"./transport":16,"./transports/index":17,"component-emitter":8,"debug":10,"engine.io-parser":23,"indexof":27,"parsejson":30,"parseqs":31,"parseuri":32}],16:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":8,"engine.io-parser":23}],17:[function(require,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling":20,"component-emitter":8,"component-inherit":9,"debug":10,"xmlhttprequest-ssl":22}],20:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":31,"xmlhttprequest-ssl":22,"yeast":37}],21:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":31,"ws":6,"yeast":37}],22:[function(require,module,exports){
(function (global){
...
},{"has-cors":26}],23:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./keys":24,"after":2,"arraybuffer.slice":3,"base64-arraybuffer":4,"blob":5,"has-binary":25,"wtf-8":36}],24:[function(require,module,exports){
...
ready(function () {
	...
	$('main a').on('mouseover', function () {
		return $body.addClass('link-hovered');
	}).on('mouseout', function () {
		return $body.removeClass('link-hovered');
	});

	$info.on('mouseover', function () {
		return $body.addClass('info-hovered');
	}).on('mouseout', function () {
		return $body.removeClass('info-hovered');
	});
	...
	socket.on('open', function () {
		socket.on('message', function (message) {
			...
			try {
				for (var _iterator = data.dots[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var d = _step.value;
...
},{"../../config":1,"./lib/dot":39,"./lib/track":40,"cash-dom":7,"domready":12,"engine.io-client":13}],39:[function(require,module,exports){
	...
	function add() {
		...
		velocity($el[0], {
			...
			complete: function complete() {
				return timeout = setTimeout(remove, INTERVAL);
			}
		});
	}
...
},{"../../../config":1,"cash-dom":7,"randf":34,"velocity-animate":35}],40:[function(require,module,exports){
